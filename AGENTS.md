...
| `service/`                   | Service detail by id (MongoDB). `service/internal` holds the unpublished, unauthenticated services search and facets routes ServiceNet's record selector uses — see [docs/internal-services-search.md](docs/internal-services-search.md) and [docs/geography-filter.md](docs/geography-filter.md). |
