...
| `metrics/`                   | Prometheus metrics (push to Pushgateway or scrape via `/metrics`; HTTP/downstream/cache counters+histograms, push self-observability); see [docs/metrics.md](docs/metrics.md).                                                                                                                                                                           |
